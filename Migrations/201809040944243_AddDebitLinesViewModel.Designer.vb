...
Namespace Migrations
    ...
    Public NotInheritable Partial Class AddDebitLinesViewModel
        Implements IMigrationMetadata
    
        Private ReadOnly Resources As New ResourceManager(GetType(AddDebitLinesViewModel))
        
        Private ReadOnly Property IMigrationMetadata_Id() As String Implements IMigrationMetadata.Id
            Get
                Return "201809040944243_AddDebitLinesViewModel"
            End Get
        End Property
