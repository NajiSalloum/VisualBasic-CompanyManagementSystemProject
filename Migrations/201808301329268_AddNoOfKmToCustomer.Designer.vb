...
Namespace Migrations
    ...
    Public NotInheritable Partial Class AddNoOfKmToCustomer
        Implements IMigrationMetadata
    
        Private ReadOnly Resources As New ResourceManager(GetType(AddNoOfKmToCustomer))
        
        Private ReadOnly Property IMigrationMetadata_Id() As String Implements IMigrationMetadata.Id
            Get
                Return "201808301329268_AddNoOfKmToCustomer"
            End Get
        End Property
