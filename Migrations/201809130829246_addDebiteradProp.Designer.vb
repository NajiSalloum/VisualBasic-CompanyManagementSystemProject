...
Namespace Migrations
    ...
    Public NotInheritable Partial Class addDebiteradProp
        Implements IMigrationMetadata
    
        Private ReadOnly Resources As New ResourceManager(GetType(addDebiteradProp))
        
        Private ReadOnly Property IMigrationMetadata_Id() As String Implements IMigrationMetadata.Id
            Get
                Return "201809130829246_addDebiteradProp"
            End Get
        End Property
