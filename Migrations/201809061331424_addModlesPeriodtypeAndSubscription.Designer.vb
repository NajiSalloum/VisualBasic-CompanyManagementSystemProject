...
Namespace Migrations
    ...
    Public NotInheritable Partial Class addModlesPeriodtypeAndSubscription
        Implements IMigrationMetadata
    
        Private ReadOnly Resources As New ResourceManager(GetType(addModlesPeriodtypeAndSubscription))
        
        Private ReadOnly Property IMigrationMetadata_Id() As String Implements IMigrationMetadata.Id
            Get
                Return "201809061331424_addModlesPeriodtypeAndSubscription"
            End Get
        End Property
