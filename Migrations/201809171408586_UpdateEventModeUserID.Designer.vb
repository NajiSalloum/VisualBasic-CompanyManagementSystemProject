...
Namespace Migrations
    ...
    Public NotInheritable Partial Class UpdateEventModeUserID
        Implements IMigrationMetadata
    
        Private ReadOnly Resources As New ResourceManager(GetType(UpdateEventModeUserID))
        
        Private ReadOnly Property IMigrationMetadata_Id() As String Implements IMigrationMetadata.Id
            Get
                Return "201809171408586_UpdateEventModeUserID"
            End Get
        End Property
