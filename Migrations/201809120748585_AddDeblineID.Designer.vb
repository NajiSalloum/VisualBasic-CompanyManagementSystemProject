...
Namespace Migrations
    ...
    Public NotInheritable Partial Class AddDeblineID
        Implements IMigrationMetadata
    
        Private ReadOnly Resources As New ResourceManager(GetType(AddDeblineID))
        
        Private ReadOnly Property IMigrationMetadata_Id() As String Implements IMigrationMetadata.Id
            Get
                Return "201809120748585_AddDeblineID"
            End Get
        End Property
