...
Namespace Migrations
    ...
    Public NotInheritable Partial Class UpdateProjectInDebitLine
        Implements IMigrationMetadata
    
        Private ReadOnly Resources As New ResourceManager(GetType(UpdateProjectInDebitLine))
        
        Private ReadOnly Property IMigrationMetadata_Id() As String Implements IMigrationMetadata.Id
            Get
                Return "201808301052219_UpdateProjectInDebitLine"
            End Get
        End Property
