    ...
    @<div class="form-horizontal">
        ...
        @Html.HiddenFor(Function(model) model.CustomerID)
         ...
         <div class="form-group">
             ...
             <div class="col-md-10">
                 @Html.DropDownListFor(Function(model) model.PriceListID, DirectCast(ViewData("PriceListID"), IEnumerable(Of SelectListItem)), ViewBag.PriceListName.ToString, New With {.class = "form-control"})
         ...
         <div class="form-group">
             ...
             <div class="col-md-10">
                 @Html.DropDownListFor(Function(model) model.CompanyID, DirectCast(ViewData("CompanyID"), IEnumerable(Of SelectListItem)), New With {.class = "form-control"})
        ...
        <div class="form-group hidden" id="PartnerLevelDropDownList">
            ...
            <div class="col-md-10">
                @Html.DropDownListFor(Function(model) model.PartnerLevelID, DirectCast(ViewData("PartnerLevelID"), IEnumerable(Of SelectListItem)), ViewBag.PartnerLevelName.ToString, New With {.class = "form-control"})
        ...
        <div class="form-group" id="KopplatPartnrtDropdownList">
            ...
            <div class="col-md-10">
                @Html.DropDownListFor(Function(model) model.KopplatPartnerID, DirectCast(ViewData("KopplatPartner"), IEnumerable(Of SelectListItem)), "Ingen Kopplat Partner", New With {.class = "form-control"})
