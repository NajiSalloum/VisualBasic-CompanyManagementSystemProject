...
@Using (Html.BeginForm())
    ...
    @<div class="form-horizontal">
        ...
        <div class="form-group">
            ...
            <div class="col-md-10">
                @Html.TextAreaFor(Function(model) model.Subscription.Description)
        ...
        <div class="form-group">
            @Html.LabelFor(Function(model) model.Subscription.Commission, New With {.class = "control-label col-md-2"})
            <div class="col-md-10">
