        ...
        @<div class="form-horizontal">
            ...
            <div class="form-group">
                ...
                <div class="col-md-10">
                    ...
                    @Html.ActionLink("Lägg till nytt projekt", "CreateAndBackToDebitLine", "Projects", New With {.id = Url.RequestContext.RouteData.Values("id")}, Nothing)
                    <br />
            ...
            <div class="form-group">
                ...
                <div class="col-md-10">
                    @Html.TextAreaFor(Function(model) model.DebitLine.Description)
