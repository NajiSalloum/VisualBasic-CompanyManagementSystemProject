...
Public Class AccountController
    ...
    Public Async Function Login(model As LoginViewModel, returnUrl As String) As Task(Of ActionResult)
        If ModelState.IsValid Then
            ...
            If appUser IsNot Nothing Then
                ...
                Dim member = db.Memberships.Where(Function(u) u.UserName = model.UserName).FirstOrDefault
    ...
    Public Function Manage(ByVal message As ManageMessageId?) As ActionResult
        ViewData("StatusMessage") =
            If(message = ManageMessageId.ChangePasswordSuccess, "Ditt lösenord har ändrats.", _
    ...
    Public Async Function Manage(model As ManageUserViewModel) As Task(Of ActionResult)
        ...
        Dim member = db.Memberships.Where(Function(u) u.UserName = userName).FirstOrDefault
        If member IsNot Nothing Then
            member.PasswordChangedDate = Date.Now
            db.Entry(member).State = EntityState.Modified
            db.SaveChanges()
        End If
        Return View(model)
